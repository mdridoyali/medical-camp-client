...
const HealthProfessional = () => {
    ...
    return (
        <div className="mb-14">
            ...
            <SectionHeading heading={'Professional profile'} ></SectionHeading>
            ...
            <div className="grid  my-5 lg:grid-cols-3 px-3 mx-auto text-center">
                <div className=" mx-auto gap-5 h-fit w-full justify-center">
                    <div className="flex gap-5  justify-between">
                        <div className="p-4 flex-shrink- bg-green-200 rounded-2xl h-fit w-full ">
                            <p>Name</p>
                ...
                <div className=" mx-auto h-fit ">
                    <div className="flex gap-5">
                        <div className="p-4 bg-sky-200 rounded-2xl h-fit w-full ">
                            <p>Address</p>
                            <h2 className="text-xl font-semibold">{address}</h2>
                        </div>
                        <div className="p-4 bg-violet-300 rounded-2xl h-fit w-full ">
                            <p>Mobile</p>
            ...
            <div className="flex justify-center p-4 mt-5 bg-blue-500 text-center rounded-2xl h-fit w-fit font-bold text-white mx-auto  ">
                Interested Camp Count ({data.length})
            </div>
        </div>
    );
};
